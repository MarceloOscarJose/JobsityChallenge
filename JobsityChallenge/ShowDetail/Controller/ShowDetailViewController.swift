...
class ShowDetailViewController: UIViewController {
    ...
    func setupControls() {
        self.containerView = PXStickyHeaderCollectionView(initHeaderHeight: 170, minHeaderHeight: 70, headerView: headerView)
    ...
    func setupConstraints() {
        ...
        let topConstraint = NSLayoutConstraint(item: self.containerView!, attribute: .top, relatedBy: .equal, toItem: self.view, attribute: .top, multiplier: 1, constant: 1)
        let bottomConstraint = NSLayoutConstraint(item: self.containerView!, attribute: .bottom, relatedBy: .equal, toItem: self.view, attribute: .bottom, multiplier: 1, constant: 1)
